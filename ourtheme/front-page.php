      ...
      <div class="frontpage-container">
         <!-- <?php echo do_shortcode('[product_categories]') ?> -->
            ...
            <div class="hero-grid">
                ...
                <div class="image4" id="hero-image"><img src="<?php echo esc_url($img3['url']); ?>" class="d-block" alt="...">  </div>
                <div class="image5" id="hero-image"><img src="<?php echo esc_url($img4['url']); ?>" class="d-block" alt="...">  </div>
            </div>
